...
import { stats_middleware } from "./funcs/middlewares/stats_middleware.js";
...
router.post("/submit_end", submit_limiter, input_validation_middleware, stats_middleware("posts"), submit_end);
